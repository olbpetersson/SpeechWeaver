 ...
 * 
 * 130423: This is a limited version of the original MymeTypeMap found at http://www.netmite.com/android/mydroid/frameworks/base/core/java/android/webkit/MimeTypeMap.java
 * Also a "." is added in front of each of the mimetypes
 * edited by Ola Petersson, olbpetersson@gmail.com.
 * 
 * This LimitedMymeMap does not hold as many values for the different keys.
 */
 ...
 */
public /* package */ class LimitedMimeTypeMap {

    /**
     * Singleton MIME-type map instance:
     */
    private static LimitedMimeTypeMap sMimeTypeMap;
     ...
     */
    public static LimitedMimeTypeMap getSingleton() {
        if (sMimeTypeMap == null) {
            sMimeTypeMap = new LimitedMimeTypeMap();
